...
var Fuzz = /** @class */ (function (_super) {
  __extends(Fuzz, _super);
  function Fuzz() {
    return (_super !== null && _super.apply(this, arguments)) || this;
  }
  Fuzz.prototype.process = function (input) {
    return __awaiter(this, void 0, void 0, function () {
      var _a, fuzzType, target, matching;
      return __generator(this, function (_b) {
        (_a = this.params), (fuzzType = _a.fuzzType), (target = _a.target);
        matching = (0, getMatchingPayloads_1["default"])(input, target);
        switch (fuzzType) {
          case "range":
            return [
              2 /*return*/,
              fuzzPayloadsIntoRange(
                matching,
                target,
          ...
          case "percent":
            return [2 /*return*/, fuzzPayloadsIntoPercent(matching, target)];
        }
        return [2 /*return*/];
      });
    });
  };
  Fuzz.prototype.getSchema = function () {
    return {
      fuzzType: {
...
exports["default"] = Fuzz;
/**
 * Fuzz payload values into bins of size `rangeStart`
 */
function fuzzPayloadsIntoRange(input, target, rangeStart, rangeSize) {
  var _a;
  var output = [];
  for (var _i = 0, input_1 = input; _i < input_1.length; _i++) {
    var payload = input_1[_i];
    var value = payload[target];
    ...
    var binHi = binLo + rangeSize - 1;
    output.push(
      __assign(
        __assign({}, payload),
        ((_a = {}),
        (_a["".concat(target)] = "".concat(binLo, "-").concat(binHi)),
        _a)
      )
    );
  }
 ...
 */
function fuzzPayloadsIntoPercent(input, target) {
  var _a;
  var output = [];
  var payloadMax = input.reduce(function (max, payload) {
    return payload.contentValue > max.contentValue ? payload : max;
  }).contentValue;
  if (typeof payloadMax !== "number") {
    throw new Error("Can only perform percent fuzz on numeric values!");
  }
  for (var _i = 0, input_2 = input; _i < input_2.length; _i++) {
    var payload = input_2[_i];
    var value = payload[target];
    output.push(
      __assign(
        __assign({}, payload),
        ((_a = {}), (_a["".concat(target)] = (value * 100) / payloadMax), _a)
      )
    );
  }
  return output;
