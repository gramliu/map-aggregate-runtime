...
var Choose = /** @class */ (function (_super) {
  ...
  Choose.prototype.process = function (input) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        if (input.length < this.params.count) {
          return [2 /*return*/, input];
        } else {
          return [2 /*return*/, input.slice(0, this.params.count)];
        }
        return [2 /*return*/];
      });
    });
  };
  Choose.prototype.getSchema = function () {
    return {
      count: {
        description:
  ...
  Choose = __decorate(
    [(0, Node_1.MapAggregateNode)("Choose", "Choose the first k payloads")],
    Choose
  );
  return Choose;
})(Node_1.Node);
