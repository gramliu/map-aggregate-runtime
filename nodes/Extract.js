...
var Extract = /** @class */ (function (_super) {
  ...
  Extract.prototype.process = function (input) {
   ...
   */
  Extract.prototype.getMedian = function (input) {
    var sorted = input.sort(function (payloadA, payloadB) {
      return payloadA > payloadB ? 1 : -1;
    });
    if (sorted.length == 0) {
  ...
  Extract = __decorate(
    [
      (0, Node_1.MapAggregateNode)(
        "Extract",
        "Extract semantic information from payloads"
      ),
    ],
    Extract
  );
